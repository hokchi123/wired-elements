import { line as roughLine, rectangle as roughRectangle, ellipse as roughEllipse, polygon as roughPolygon, arc as roughArc, doubleLineFillOps, generateEllipseParams } from 'roughjs/bin/renderer';
...
export function arc(parent, x, y, width, height, start, stop, seed) {
    width = Math.max(width > 10 ? width - 4 : width - 1, 1);
    height = Math.max(height > 10 ? height - 4 : height - 1, 1);
